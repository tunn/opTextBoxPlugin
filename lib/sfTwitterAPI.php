...
class sfTwitterAPI
{
  static public function tweet($message)
  {
    ...
    $consumer_key = "A3UyCCpWzPJ34tmSfNqX4g";//sfConfig::get('app_sfTwitterAuth_consumer_key');
    $consumer_secret = "M3p8nXmRm3cMkMLG99vt4mPsLdpP1nkbdqTdXZM7tyw";//sfConfig::get('app_sfTwitterAuth_consumer_secret');
